...
public class tabbedmanagementdashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (position) {
            case 0:
//                wvMgmtDashboard.loadUrl("http://erpsrm.com/evarsitysrmh/evarsityshasun/dashboard/reports/AdmissionCurrentYear.jsp");
//                break;
            case 1:
                tvPageTitle.setText("MIS Reports - Due List");
                wvMgmtDashboard.loadUrl("https://erpsrm.com/evarsitysrmh/dashboard/reports/DueList.jsp");
                break;
            case 2:
                tvPageTitle.setText("MIS Reports - Staff Birthday");
                wvMgmtDashboard.loadUrl("https://erpsrm.com/evarsitysrmh/dashboard/reports/BirthdayList.jsp");
                break;
            case 3:
                tvPageTitle.setText("MIS Reports - Staff Attendance");
                wvMgmtDashboard.loadUrl("https://erpsrm.com/evarsitysrmh/dashboard/reports/StaffLeaveDetails.jsp");
                break;
//            case 4:
//                wv.loadUrl("http://erp.shasuncollege.edu.in/evarsityshasun/dashboard/reports/GrievanceCell.jsp");
//                break;
            case 4:
                tvPageTitle.setText("MIS Reports - Library Details");
                wvMgmtDashboard.loadUrl("https://erpsrm.com/evarsitysrmh/dashboard/reports/LibraryDetailsforMobile.jsp?EmployeeId=0");
                break;
            case 5:
                tvPageTitle.setText("MIS Reports - Voucher Details");
                wvMgmtDashboard.loadUrl("https://erpsrm.com/evarsitysrmh/dashboard/reports/VoucherAndReconciledforMobile.jsp");
                break;
//            case 7:
