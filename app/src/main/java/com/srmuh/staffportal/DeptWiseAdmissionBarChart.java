...
public class DeptWiseAdmissionBarChart extends AppCompatActivity implements OnChartValueSelectedListener {
...
//        startActivity(intent);
        ...
        Toast.makeText(DeptWiseAdmissionBarChart.this, "Value: " + e.getVal() + ", xIndex: " + e.getXIndex()
